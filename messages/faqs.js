...
module.exports = async (client, linksChannel) => {
	try {
		...
		const faqs = [
			{ name: 'What is the max supply for DOGEC?', value: '21,000,000 DOGEC', inline: false },
			{ name: 'How many coins are required for a masternode?', value: '5,000 DOGEC', inline: false },
			{ name: 'How many coins are required for staking?', value: 'There isn\'t a minimum amount', inline: false },
			{ name: 'What is the average block time?', value: '1 minute', inline: false },
			{ name: 'How long is the maturity time?', value: 'Around an hour', inline: false },
		...
		const faqsMessage = createEmbed('DogeCash FAQ', faqs, 'This section will get edited as we get more of the same questions frequently asked');
